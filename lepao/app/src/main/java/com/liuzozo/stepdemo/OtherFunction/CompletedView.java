...
public class CompletedView extends View {
    ...
    public void  setmTotalProgress(double progress){
...
*/
        mRadius = 130;
        mStrokeWidth = 25;
        /* mCircleColor = typeArray.getColor(R.styleable.TasksCompletedView_circleColor, 0x00FFFFFF);*/
        mCircleColor = 0x00FFFFFF;//#0E6C67
        /*  mRingColor = typeArray.getColor(R.styleable.TasksCompletedView_ringColor, 0xFFFFFFFF);*/
        mRingColor = 0xFFFFFFFF;
        /*  mRingBgColor = typeArray.getColor(R.styleable.TasksCompletedView_ringBgColor, 0xFFFFFFFF);*/
        mRingBgColor = 0x20FFFFFF;
    ...
    private void initVariable() {
        ...
        mTextPaint.setTextSize((float)(mRadius / 2.5));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mProgress > 0 ) {
            ...
            //字体
            txt = String.format("%.2f",mProgress) + " " + unit;
